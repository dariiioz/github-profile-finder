    ...
    return (
        <div
            ...
            <h2 className="text-center sm:text-lg text-white animate__animated animate__fadeIn">
                Type your username research in input to start to find !
                <svg
                    className="w-8 h-8 fill-white mt-4 text-center mx-auto"
            ...
            {searchValue && (
                <button
                    ...
                    className="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded mt-4 mx-auto block">
                    Remove filter
                </button>
            )}
